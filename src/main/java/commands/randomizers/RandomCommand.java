...
public class RandomCommand extends ListenerAdapter {
    public static CommandData commandData = Commands.slash("random", "Randomizers")
            .addSubcommands(
                    new SubcommandData("word", "Responds with a random word")
                            .addOptions(
                                    new OptionData(OptionType.INTEGER, "amount", "Amount of words")
                            ),
                    new SubcommandData("integer", "Responds with a random integer")
                            .addOptions(
                                    new OptionData(OptionType.INTEGER, "minimum", "Minimum Limit", true),
                                    new OptionData(OptionType.INTEGER, "maximum", "Maximum Limit", true)
                            ),
